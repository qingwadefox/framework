 ...
 */
package org.qingfox.framework.microservice.factory;
...
public class MicroserviceFactory {
	...
	private static ServerBean serviceBean;

	public static ServerBean getServiceBean() {
		if (serviceBean == null) {
			serviceBean = new ServerBean();
		}
		return serviceBean;
	}

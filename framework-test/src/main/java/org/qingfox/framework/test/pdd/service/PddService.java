...
import org.qingfox.framework.common.tool.websocket.WebSocketClient;
...
import org.qingfox.framework.common.utils.ImageUtils;
...
public class PddService extends LoginService implements ISellService {
    ...
    public void refreshCode() throws Exception {
        ...
        if (responseJSON == null || !responseJSON.getBooleanValue("result")) {
            throw new RuntimeException("请求验证码失败【" + (responseJSON == null ? "" : responseJSON.getString("error_msg")) + "】");
        }

        token = responseJSON.getJSONObject("data").getString("token");
        logger.debug("token【", token, "】");
        if (StringUtils.isEmpty(token)) {
            throw new RuntimeException("获取到token为空");
        }
    ...
    public void login(String username, String password, String code) throws Exception {
        ...
        if (StringUtils.isEmpty(mallId)) {
            throw new RuntimeException("商店ID为空");
        }
        ...
        if (responseJSON == null || !responseJSON.getBooleanValue("success")) {
            throw new RuntimeException("请求sku信息失败【" + (responseJSON == null ? "" : responseJSON.getString("error_msg")) + "】");
        }
        ...
        if (responseJSON == null || !responseJSON.getBooleanValue("success")) {
            throw new RuntimeException("初始化运费模板ID失败【" + (responseJSON == null ? "" : responseJSON.getString("error_msg")) + "】");
        }
        ...
        if (StringUtils.isEmpty(this.costTemplateId)) {
            throw new RuntimeException("运费模板ID为空");
        }

        logger.info("初始化主营分类ID");
        responseJSON = this.postResult(URLConstant.PDD_MAINCAT, null);
        if (responseJSON == null || !responseJSON.getBooleanValue("success")) {
            throw new RuntimeException("初始化主营分类ID失败【" + (responseJSON == null ? "" : responseJSON.getString("error_msg")) + "】");
        }
        ...
        if (StringUtils.isEmpty(this.mainCatId)) {
            throw new RuntimeException("主营分类ID为空");
        }
    ...
    public void createGoods(GoodsEntity goods) throws Exception {
        ...
        if (responseJSON == null || !responseJSON.getBooleanValue("success")) {
            throw new RuntimeException(responseJSON.getString("error_code") + "获取商品ID以及商品SN失败【" + (responseJSON == null ? "" : responseJSON.getString("error_msg")) + "】");
        }
        ...
        if (StringUtils.isEmpty(goodsSn)) {
            throw new RuntimeException("商品SN为空");
        }
        ...
        if (StringUtils.isEmpty(goods.getSellCatId())) {
            ...
            throw new RuntimeException("商品分类ID为空");
        }
        if (StringUtils.isEmpty(goods.getSellCatId())) {
            throw new RuntimeException("商品分类ID为空");
        }
        ...
        if (responseJSON == null || !responseJSON.getBooleanValue("success")) {
            throw new RuntimeException("保存商品信息失败【" + (responseJSON == null ? "" : responseJSON.getString("error_msg")) + "】");
        }

        // 验证市场价
        if (StringUtils.isEmpty(goods.getCurrentprice())) {
            throw new RuntimeException("商品市场价为空");
        }
        ...
        if (StringUtils.isEmpty(goods.getBuyUrl())) {
            throw new RuntimeException("购买地址为空");
        }
        ...
        if (cycleImages == null || cycleImages.isEmpty()) {
            throw new RuntimeException("商品图片为空");
        }
        ...
        if (!hasDescImage) {
            throw new RuntimeException("详情图为空");
        }
        ...
        if (skuList == null || skuList.isEmpty()) {
            throw new RuntimeException("sku列表为空");
        }
        ...
        if (responseJSON == null || !responseJSON.getBooleanValue("success")) {
            throw new RuntimeException("发布商品失败【" + (responseJSON == null ? "" : responseJSON.getString("error_msg")) + "】");
        }
    }
    ...
    private ImageEntity uploadImage(String url, Integer width, Integer height, Integer length, String limitWidth, String limitHeight) throws Exception {
        ...
        try {
            ...
            if (responseJSON == null || !responseJSON.getBooleanValue("success")) {
                throw new RuntimeException("请求上传CODE失败【" + (responseJSON == null ? "" : responseJSON.getString("error_msg")) + "】");
            }
            ...
            try {
                ...
                throw new RuntimeException("将图片转化为BASE64字符串失败");
            }
            ...
            if (StringUtils.isEmpty(resultUrl)) {
                throw new RuntimeException("图片上传返回地址为空");
            }
    ...
    public List<GoodsEntity> getGoodsList() throws Exception {
        ...
        do {
            ...
            if (responseJson == null || !responseJson.getBooleanValue("result")) {
                throw new RuntimeException("获取商品列表失败【" + (responseJson == null ? "" : responseJson.getString("error_msg")) + "】");
            }
    ...
    public Integer getSkuSpec(String parentId, String specName) throws Exception {
        ...
        if (responseJSON == null || !responseJSON.getBooleanValue("success")) {
            throw new RuntimeException("新建sku信息失败【" + (responseJSON == null ? "" : responseJSON.getString("error_msg")) + "】");
        }

        Integer skuId = responseJSON.getInteger("result");
        if (skuId == null) {
            throw new RuntimeException("新建skuId为空");
        }
    ...
    public List<OrderEntity> getOrderList() throws Exception {
        ...
        do {
            ...
            for (int i = 0; i < pageItems.size(); i++) {
                ...
                logger.debug("goodsSn【", goodsSn, "】");
                if (StringUtils.isEmpty(goodsSn)) {
                    throw new RuntimeException("goodsSn为空");
                }
                GoodsEntity goods = getGoods(goodsSn);
                logger.debug("buyUrl【", goods.getBuyUrl(), "】");
                if (StringUtils.isEmpty(goods.getBuyUrl())) {
                    throw new RuntimeException("buyUrl为空");
                }
        ...
        do {
            ...
            if (responseJSON == null || !responseJSON.getBooleanValue("success")) {
                throw new RuntimeException("获取订单失败【" + (responseJSON == null ? "" : responseJSON.getString("error_msg")) + "】");
            }
    ...
    private OrderEntity getOrder(String orderSn, String skuId) throws Exception {
        ...
        if (StringUtils.isEmpty(orderSn)) {
            throw new RuntimeException("orderSn为空");
        }
        ...
        if (responseJson == null || !responseJson.getBooleanValue("success")) {
            throw new RuntimeException("获取订单详情失败【" + (responseJson == null ? "" : responseJson.getString("error_msg")) + "】");
        }
        ...
        if (StringUtils.isEmpty(orderTime)) {
            throw new RuntimeException("orderTime为空");
        }
        ...
        if (StringUtils.isEmpty(goodsNumber)) {
            throw new RuntimeException("goodsNumber为空");
        }
        ...
        if (StringUtils.isEmpty(provinceId)) {
            throw new RuntimeException("provinceId为空");
        }
        ...
        if (StringUtils.isEmpty(provinceName)) {
            throw new RuntimeException("provinceName为空");
        }
        ...
        if (StringUtils.isEmpty(cityId)) {
            throw new RuntimeException("cityId为空");
        }
        ...
        if (StringUtils.isEmpty(cityName)) {
            throw new RuntimeException("cityName为空");
        }
        ...
        if (StringUtils.isEmpty(districtId)) {
            throw new RuntimeException("districtId为空");
        }
        ...
        if (StringUtils.isEmpty(districtName)) {
            throw new RuntimeException("districtName为空");
        }
        ...
        if (StringUtils.isEmpty(shippingAddress)) {
            throw new RuntimeException("shippingAddress为空");
        }
        ...
        if (StringUtils.isEmpty(amount)) {
            throw new RuntimeException("amount为空");
        }
        ...
        if (StringUtils.isEmpty(receiveName)) {
            throw new RuntimeException("receiveName为空");
        }
        ...
        if (responseJson == null || !responseJson.getBooleanValue("success")) {
            throw new RuntimeException("查询手机号码失败【" + (responseJson == null ? "" : responseJson.getString("error_msg")) + "】");
        }
        ...
        if (StringUtils.isEmpty(receiveMobile)) {
            throw new RuntimeException("查询手机号码为空");
        }
        ...
        if (StringUtils.isEmpty(order.getBuySkuId())) {
            throw new RuntimeException("buySkuId为空");
        }
    ...
    private GoodsEntity getGoods(String goodsSn) throws Exception {
        ...
        if (responseJson == null || !responseJson.getBooleanValue("success")) {
            throw new RuntimeException("获取商品详情失败【" + (responseJson == null ? "" : responseJson.getString("error_msg")) + "】");
        }
        ...
        if (StringUtils.isEmpty(outGoodsSn)) {
            throw new RuntimeException("outGoodsSn为空");
        }
        ...
        if (outGoodsSns.length == 0 || outGoodsSns.length != 3 || !outGoodsSns[0].equals("pdd")) {
            throw new RuntimeException("外部SN格式不匹配");
        }
        ...
        if (skusList == null || skusList.isEmpty()) {
            throw new RuntimeException("skusList为空");
        }
    ...
    public String getGoodsSn(String goodsId) throws Exception {
        ...
        if (responseJson == null || !responseJson.getBooleanValue("result")) {
            throw new RuntimeException("获取商品SN失败【" + (responseJson == null ? "" : responseJson.getString("error_msg")) + "】");
        }
    ...
    public void ship(OrderEntity order) throws Exception {
        ...
        if (StringUtils.isEmpty(expressName)) {
            throw new RuntimeException("快递名称为空");
        }
        ...
        if (StringUtils.isEmpty(shippingId)) {
            throw new RuntimeException("shippingId为空");
        }
        if (StringUtils.isEmpty(shippingName)) {
            throw new RuntimeException("shippingName为空");
        }
        ...
        if (responseJson == null || !responseJson.getBooleanValue("success")) {
            throw new RuntimeException("发货失败【" + (responseJson == null ? "" : responseJson.getString("error_msg")) + "】");
        }
    }
